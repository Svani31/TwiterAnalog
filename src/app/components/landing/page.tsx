...
export default function LandingPage() {
  ...
  return (
    <div className="flex justify-center items-center h-screen m-auto gap-40">
      {/* logo */}
      <div>
      ...
      <div>
        <div className="flex flex-col text-start gap-5">
          ...
          <div className="flex flex-row text-center items-center">
            <span style={{background:"white",height:"2px",width:"175px"}}></span>
          ...
          <div
            ...
            className="border-2 rounded-3xl p-2 justify-center flex cursor-pointer"
          >
